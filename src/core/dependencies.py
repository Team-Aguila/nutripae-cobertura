...
def require_create():
    return require_permission("nutripae-cobertura:create")

def require_read():
    return require_permission("nutripae-cobertura:read")

def require_list():
    return require_permission("nutripae-cobertura:list")

def require_update():
    return require_permission("nutripae-cobertura:update")

def require_delete():
    return require_permission("nutripae-cobertura:delete") 